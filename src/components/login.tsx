import { createLucideIcon, Feather } from "lucide-react";
...
const GithubIcon = createLucideIcon("Github", [
  [
    "path",
    {
      ...
      fill: "#24292f",
      key: "Github",
      transform: "scale(.24) translate(1, 0)",
    },
  ],
]);
    ...
    >
      <AnimatePresence initial={false} mode="wait">
        {!isExpanded ? (
          ...
          >
            <motion.h2 layout="position" className="font-medium text-lg mb-1">
              Sign in to continue!
            </motion.h2>
            <motion.div
              layout="position"
              className="w-[90%] h-[1px] bg-zinc-700 my-1"
            ></motion.div>
            <motion.div
              layout="position"
            ...
            >
              ...
              >
                <motion.div layout="position">
                  <XIcon className="h-7 w-7" color="#24292f" fill="#24292f" />
                </motion.div>
              </motion.button>
            </motion.div>
          </motion.div>
